...
class _CustomVoiceRecordeState extends State<CustomVoiceRecorde> {
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<VoiceRecorderProvider>(builder: (context, provider, _) {
      return StreamBuilder<RecordingDisposition>(
          ...
          builder: (context, snapshot) {
            ...
            final towDigitsMinutes = towDigits(duration.inMinutes.remainder(60));
              ...
              replacement: Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Expanded(child: SizedBox(child: Text('$towDigitsMinutes:$towDigitSecond'))),
                    Row(
                      children: [
                        IconButton(onPressed: () async{
                          if(provider.isPlaying){
                            ...
                            await provider.audioPlayer.play(DeviceFileSource(provider.audioFile!.path));
                          }
