...
class ReadNotificationUseCase extends UseCase<BaseResponseModel<dynamic>, int> {
  final SettingRepository settingRepository;
  ReadNotificationUseCase({required this.settingRepository});

  @override
  Future<Either<BaseErrorModel, BaseResponseModel<dynamic>>>? call(
      int params) async {
    return await settingRepository.readNotification(params);
  }
}
