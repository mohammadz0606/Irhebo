...
class GetServiceBySubcategoryIdUseCase
    extends UseCase<BaseResponseModel<AllServices>, PaginationParams> {
  final HomeRepository homeRepository;
  GetServiceBySubcategoryIdUseCase({required this.homeRepository});

  @override
  Future<Either<BaseErrorModel, BaseResponseModel<AllServices>>>? call(
      PaginationParams params) async {
    return await homeRepository.getServicesBySubcategoryId(params);
  }
}
